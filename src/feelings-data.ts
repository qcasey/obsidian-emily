...
export const FEELINGS_WHEEL: EmotionSector[] = [
	{
		...
		color: "#E88501",
		secondary: [
			{label: "Playful", tertiary: ["Silly", "Lighthearted"]},
			{label: "Proud", tertiary: ["Accomplished", "Capable"]},
	...
	},
	{
		...
		secondary: [
			...
			{label: "Loving", tertiary: ["Warm", "Affectionate"]},
			{label: "Interested", tertiary: ["Curious", "Inquisitive"]},
			{label: "Hopeful", tertiary: ["Optimistic", "Encouraged"]},
			{label: "Grateful", tertiary: ["Appreciative", "Touched"]},
		],
	},
	{
		core: "Quiet",
		...
		secondary: [
			...
			{label: "Ambivalent", tertiary: ["Torn", "Conflicted"]},
